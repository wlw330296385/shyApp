...
page.on("result", function(data) {
	...
	if (data.path && data.img == 1){
		...
		http.url = "http://testapi.e-shy.com/index.php/index/File_upload/uploadImage/token/"+token;
...
do_Button_1.on('touch',function(){
	...
	http3.url = "http://testapi.e-shy.com/index.php/index/Oilcard/addCard/token/"+token;
