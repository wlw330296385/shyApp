...
ui("$").setMapping({
	...
	"do_ALayout_1.visible":'data.kaijiang_is_true',
	"do_ALayout_6.visible":"data.buzhongjian_is_true",
	"do_ALayout_7.visible":"data.meikaijiang_is_true",
...
ui('$').on('dataRefreshed',function(){
	if(ui('do_ALayout_1').tag == 0){
		//没开奖
		ui('do_ALayout_1').visible = false;//开奖窗口
		ui('do_ALayout_6').visible = false;//积分
		ui('do_ALayout_7').visible = true;//没开奖窗口
	}else{
		//如果开了奖
		ui('do_ALayout_1').visible = true;				
