...
var http = mm('do_Http');
http.url = "http://testapi.e-shy.com/index.php/index/panicbuy/panicbuy_item/token/"+token;
http.method = "POST";
...
httpIsGoPay.url = "http://testapi.e-shy.com/index.php/index/panicbuy/isGoPay/token/"+token;
