...
//http = mm('do_Http');
////http.url = "http://testapi.e-shy.com/index.php/index/charge/orderPay";
//http.url = "http://testapi.e-shy.com/index.php/index/charge/orderPay";
...
//	更换方式
	...
	var urlToPay = "http://testapi.e-shy.com/index.php/index/charge/payOrder?payMethodId="+payMethodId+"&orderId="+orderId+"&userId="+userId;
	var uerParam = {
			"title":"普通商品订单支付",
			"url":urlToPay
	}
