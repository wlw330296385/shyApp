...
//				url:'http://192.168.1.167:8099/index.php/index/user/login',
				url:'http://192.168.1.104:9527/index.php/index/user/login',
				data:postData,
				type:'POST',
				contentType:'application/json',
				success:function(userData){
					if(userData.code == 1){
						storage.writeFile('data://userInfo',userData,function(boo){						
//						core.p(JSON.stringify(data));	
//							core.p(boo);//bool == true
						core.p(userData)
						notify.toast('登陆成功');
