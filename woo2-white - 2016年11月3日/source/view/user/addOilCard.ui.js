...
page.on("result", function(data) {
	...
	if (data.path && data.img == 1){
		...
		http.url = "http://api.e-shy.com/index.php/index/File_upload/uploadImage";
	...
	if(data.action == 1 ){
		camera.capture(256, -1, 100, true, function(imgUrl) {
	        ...
	        http2.url = "http://api.e-shy.com/index.php/index/File_upload/uploadImage";
...
do_Button_1.on('touch',function(){
	...
	http3.url = "http://api.e-shy.com/index.php/index/Oilcard/addCard";
	http3.contentType = "application/json";
	var userInfo = storage.readFileSync('data://userInfo',true);
	http3.setRequestHeader("Cookie", "PHPSESSID=" + userInfo.data.session_id);
	http3.body = {
