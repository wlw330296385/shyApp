 ...
 */
var app,page,core,goods_id,dataCache,kess,global,token;
app = sm('do_App');
page = sm('do_Page');
...
http.url = "http://192.168.1.109:9999/index.php/index/panicbuy/order";
http.method = "POST";
...
//http2.url = "http://192.168.1.109:9999/index.php/index/panicbuy/order_create";
//http2.method = "POST";
...
ui('do_Button_1').on('touch','',3000,function(){
	...
	var payUrl = "http://192.168.1.109:9999/index.php/index/panicbuy/order_create";
