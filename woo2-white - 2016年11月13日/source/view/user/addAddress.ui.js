...
http.url = "http://192.168.1.109:9999/index.php/index/Panicbuy/addAddress";
...
ui('do_Button_1').on('touch','',3000,function(){
	...
	token = algorithm.des3Sync('','encrypt',kess.lockIt(userInfo.data.id));
	if(city =='' || county == ''){
